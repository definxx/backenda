        ...
        @foreach($sharespaces as $sharespace)
            <div class="bg-white p-4 rounded-lg shadow-lg">
                ...
                <div class="flex space-x-2">
                    ...
                    <form action="{{ route('sharespaces.destroy', $sharespace->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this sharespace?');">
                        @csrf
                        @method('DELETE')
                        <button
                            type="submit"
