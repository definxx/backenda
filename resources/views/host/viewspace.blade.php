            ...
            <div class="bg-white p-4 rounded-lg shadow-lg">
                ...
                <form action="{{ route('uploadprofile') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        <h3 class="text-xl font-bold text-gray-700">
                            <i class="fas fa-home text-orange mr-2"></i>
                ...
                <div class="flex space-x-2 mt-4">
                    <button id="book-button" 
                        ...
                        <i class="fas fa-info-circle"></i> Book 
                    </button>
                </div>
            </div>
        @else
        ...
        <form action="{{ route('book.apartment') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <div class="flex items-center border border-gray-300 rounded-md">
                    <i class="fa fa-calendar-alt text-orange p-2"></i>
            ...
            <div class="mb-4">
                ...
                <div class="flex items-center border border-gray-300 rounded-md">
                    <i class="fa fa-users text-orange p-2"></i>
            ...
            <div class="text-right">
                <button class="bg-orange text-white px-4 py-2 rounded-md hover:bg-orange-700">
